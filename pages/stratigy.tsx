...
export default function lessons() {
  ...
  return (
    ...
    <div className="flex-row md:ml-8 gap-2 md:gap-7 flex pt-12 justify-center text-green-400  text-[12px] md:text-[20px]">
        <Link className=' border border-1 border-green-400 rounded-md px-2 py-1' href={"/lessons"}>all</Link>
        ...
        <MovieList title="stratigy" data={movies} />
