    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              <a href="http://www.facebook.com/profile.php?id=61551108354799&mibextid=2JQ9oc" target="_blank"  className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://www.youtube.com/@ChessChain" target="_blank"  className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://www.instagram.com/chess_chain?igshid=MzNINGNkZWQ4Mg==" target="_blank"  className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://t.me/ChessChain" target="_blank"  className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://lichess.org/team/chess-chain" target="_blank"  className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
